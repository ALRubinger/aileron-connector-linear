...
version = "0.0.0-dev"
source = "github://ALRubinger/aileron-connector-linear/actions/search-projects@0.0.0-dev"

[[requires.connectors]]
name = "github://ALRubinger/aileron-connector-linear"
version = "0.0.0-dev"
hash = "sha256:bound-at-release"
capabilities = ["search_projects"]

[match]
intent = "Search projects by text query using full-text and vector search. Results are ranked by relevance unless an orderBy parameter is specified. Rate-limited to 30 requests per minute."
