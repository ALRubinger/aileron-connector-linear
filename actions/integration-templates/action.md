...
version = "0.0.0-dev"
source = "github://ALRubinger/aileron-connector-linear/actions/integration-templates@0.0.0-dev"

[[requires.connectors]]
name = "github://ALRubinger/aileron-connector-linear"
version = "0.0.0-dev"
hash = "sha256:bound-at-release"
capabilities = ["integration_templates"]

[match]
intent = "All integration template connections for the workspace, linking templates to integrations."

[[execute]]
id = "integration"
connector = "github://ALRubinger/aileron-connector-linear"
op = "integration_templates"
idempotent = true
