...
name = "issues"
version = "0.0.0-dev"
source = "github://ALRubinger/aileron-connector-linear/actions/issues@0.0.0-dev"
...
[match]
intent = "All issues. Returns a paginated list of issues visible to the authenticated user. Can be filtered by various criteria including team, assignee, state, labels, project, and cycle."
...
name = "release"
type = "ReleaseSort"
description = "Sort by most recent release date"
required = false
