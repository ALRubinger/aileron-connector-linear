+++
name = "issue-figma-file-key-search"
version = "0.0.0-dev"
source = "github://ALRubinger/aileron-connector-linear/actions/issue-figma-file-key-search@0.0.0-dev"

[[requires.connectors]]
name = "github://ALRubinger/aileron-connector-linear"
version = "0.0.0-dev"
hash = "sha256:bound-at-release"
capabilities = ["issue_figma_file_key_search"]

[match]
intent = "Find issues that are related to a given Figma file key."

[[execute]]
id = "issue"
connector = "github://ALRubinger/aileron-connector-linear"
op = "issue_figma_file_key_search"
idempotent = true
