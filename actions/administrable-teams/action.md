+++
name = "administrable-teams"
version = "0.0.0-dev"
source = "github://ALRubinger/aileron-connector-linear/actions/administrable-teams@0.0.0-dev"

[[requires.connectors]]
name = "github://ALRubinger/aileron-connector-linear"
version = "0.0.0-dev"
hash = "sha256:bound-at-release"
capabilities = ["administrable_teams"]

[match]
intent = "All teams whose settings the user can administer. This includes teams the user can change settings for, but whose issues they may not have direct access to. This differs from the `teams` query which returns teams based on issue access."

[[execute]]
id = "administrable"
connector = "github://ALRubinger/aileron-connector-linear"
op = "administrable_teams"
idempotent = true
