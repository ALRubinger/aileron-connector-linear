...
version = "0.0.0-dev"
source = "github://ALRubinger/aileron-connector-linear/actions/release-pipelines@0.0.0-dev"

[[requires.connectors]]
name = "github://ALRubinger/aileron-connector-linear"
version = "0.0.0-dev"
hash = "sha256:bound-at-release"
capabilities = ["release_pipelines"]

[match]
intent = "All release pipelines in the workspace, with optional filtering and sorting."

[[execute]]
id = "release"
connector = "github://ALRubinger/aileron-connector-linear"
op = "release_pipelines"
idempotent = true
...
description = "Comparator for the pipeline production flag."
required = false
...
[[inputs]]
name = "name"
type = "ReleasePipelineNameSort"
description = "Sort by release pipeline name."
required = false
...
description = "Filters that the release pipeline's teams must satisfy."
required = false
