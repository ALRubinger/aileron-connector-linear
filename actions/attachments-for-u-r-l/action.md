+++
name = "attachments-for-u-r-l"
version = "0.0.0-dev"
source = "github://ALRubinger/aileron-connector-linear/actions/attachments-for-u-r-l@0.0.0-dev"

[[requires.connectors]]
name = "github://ALRubinger/aileron-connector-linear"
version = "0.0.0-dev"
hash = "sha256:bound-at-release"
capabilities = ["attachments_for_u_r_l"]

[match]
intent = "Returns issue attachments for a given `url`."

[[execute]]
id = "attachments"
connector = "github://ALRubinger/aileron-connector-linear"
op = "attachments_for_u_r_l"
idempotent = true
